const data = [
    ...
    { id: 2, fullName: 'Andrik Gilberto García Sánchez', puesto:'Subdirector de Gobierno Abierto', area: 'Unidad de Políticas Anticorrupción - Dirección General de Transparencia y Gobierno Abierto', email: 'andrik.garcía@funcionpublica.gob.mx', extension: '1418' },
    ...
    { id: 14, fullName: 'Eduardo Vargas Ortiz', puesto:'Director de Gobierno Abierto', area: 'Unidad de Políticas Anticorrupción - Dirección General de Transparencia y Gobierno Abierto', email: 'evargas@funcionpublica.gob.mx', number: '123-456-7890', extension: '1023' },
    ...
    { id: 19, fullName: 'Arturo Jaime Magallanes', puesto:'Director de Análisis de Acceso a la Información Pública Gobierno Abierto y Datos Públicos con Tecnologías de Información y Comunicaciones', area: 'Unidad de Políticas Anticorrupción - Dirección General de Transparencia y Gobierno Abierto', email: 'arturo.jaime@funcionpublica.gob.mx', extension: '1080' },
    ...
    { id: 22, fullName: 'Irving Manchinelly Mota', puesto:'Subdirector de Gestión de Solicitudes de Acceso a la Información', area: 'Unidad de Políticas Anticorrupción - Dirección General de Transparencia y Gobierno Abierto', email: 'irving.manchinelly@funcionpublica.gob.mx', extension: '1433' },
